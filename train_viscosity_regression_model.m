function [trainedModel, validationRMSE] = train_viscosity_regression_model(trainingData)
...
% Auto-generated by MATLAB on 16-Mar-2026 21:49:14
...
predictorNames = {'beaker_size', 'rpm', 'temp_mean', 'accelX_mean', 'accelX_std', 'accelX_rms', 'accelY_mean', 'accelY_std', 'accelY_rms', 'accelZ_mean', 'accelZ_std', 'accelZ_rms', 'gyroX_mean', 'gyroX_std', 'gyroX_rms', 'gyroY_mean', 'gyroY_std', 'gyroY_rms', 'gyroZ_mean', 'gyroZ_std', 'gyroZ_rms', 'magnX_mean', 'magnX_std', 'magnX_rms', 'magnY_mean', 'magnY_std', 'magnY_rms', 'magnZ_mean', 'magnZ_std', 'magnZ_rms'};
predictors = inputTable(:, predictorNames);
response = inputTable.visc_frac;
...
trainedModel.RequiredVariables = {'beaker_size', 'rpm', 'temp_mean', 'accelX_mean', 'accelX_std', 'accelX_rms', 'accelY_mean', 'accelY_std', 'accelY_rms', 'accelZ_mean', 'accelZ_std', 'accelZ_rms', 'gyroX_mean', 'gyroX_std', 'gyroX_rms', 'gyroY_mean', 'gyroY_std', 'gyroY_rms', 'gyroZ_mean', 'gyroZ_std', 'gyroZ_rms', 'magnX_mean', 'magnX_std', 'magnX_rms', 'magnY_mean', 'magnY_std', 'magnY_rms', 'magnZ_mean', 'magnZ_std', 'magnZ_rms'};
